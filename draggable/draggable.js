...
var $author$project$Draggable$receivePortMessage = _Platform_incomingPort(
	'receivePortMessage',
	$elm$json$Json$Decode$list($elm$json$Json$Decode$int));
var $author$project$Draggable$subscriptions = function (_v0) {
...
var $author$project$Draggable$encodeAndSendPortMessage = function (message) {
	return $author$project$Draggable$sendPortMessage(
		$author$project$Draggable$encodePortMessage(message));
};
...
var $author$project$Draggable$decodePortMessage = function (message) {
	if (((((message.b && message.b.b) && message.b.b.b) && message.b.b.b.b) && message.b.b.b.b.b) && (!message.b.b.b.b.b.b)) {
		...
		var _v4 = _v3.b;
		var x = _v4.a;
		var offsetY = offsets >> 8;
		var offsetX = 255 & offsets;
		var extra = extraAndAction >> 8;
		var action = 255 & extraAndAction;
		switch (action) {
			case 0:
			...
			case 2:
				return A5($author$project$Draggable$DraggableGrabbed, owner, offsetY, offsetX, y, x);
			case 3:
				return A5($author$project$Draggable$DraggablePutted, owner, offsetY, offsetX, y, x);
			case 4:
				return A5($author$project$Draggable$DraggableMoved, owner, offsetY, offsetX, y, x);
			default:
				return $author$project$Draggable$IncorrectPortMessageAction(message);
		}
	} else {
		return $author$project$Draggable$IncorrectPortMessageArray(message);
	}
};
var $author$project$Draggable$stringifyListInt = function (list) {
	if (list.b) {
		var x = list.a;
		var xs = list.b;
		return $elm$core$String$fromInt(x) + (' ' + $author$project$Draggable$stringifyListInt(xs));
	} else {
		return '';
	}
};
var $author$project$Draggable$stringifyIncomingPortMessage = function (message) {
	switch (message.$) {
		...
		default:
			var raw = message.a;
			return 'IncorrectPortMessageArray ' + $author$project$Draggable$stringifyListInt(raw);
	}
};
var $author$project$Draggable$updateOnPortMessageReceived = F2(
...
var $author$project$Draggable$update = F2(
	function (msg, model) {
		update:
		while (true) {
			switch (msg.$) {
...
var $author$project$Draggable$decodeMousePosition = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Draggable$MousePosition,
	A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Events$on,
				'mousemove',
				A2($elm$json$Json$Decode$map, $author$project$Draggable$MouseMove, $author$project$Draggable$decodeMousePosition)),
				A2(
				$elm$html$Html$Events$on,
				'mouseup',
				A2($elm$json$Json$Decode$map, $author$project$Draggable$MouseUp, $author$project$Draggable$decodeMousePosition))
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('https://github.com/sluchaynayakotya/-elm/blob/master/draggable/src/Draggable.elm'),
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'left', draggableX),
						A2($elm$html$Html$Attributes$style, 'top', draggableY),
						A2($elm$html$Html$Attributes$style, 'background', draggableColor),
						A2(
						$elm$html$Html$Events$on,
						'mousedown',
						A2($elm$json$Json$Decode$map, $author$project$Draggable$DraggableMouseDown, $author$project$Draggable$decodeMousePosition))
					]),
				_List_fromArray(
					[
